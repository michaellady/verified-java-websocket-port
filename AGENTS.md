...
digest-pinned CBMC 6.11.0 Ubuntu package. It requires Ubuntu 24.04 on Linux
amd64. No secret is required. The repository bootstrap must not call Kani's
upstream system-dependency installer.
