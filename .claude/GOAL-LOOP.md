...
- **P1 Land the merge queue**, strictly one branch per firing, in the
  ...
  deletion. What remains before it can land: review 01a04961's finding 7
  (case-manifest independence, snapshot-derived); AC1's bounded-resources
  clause, recorded unmet — **owner gate, needs a new host**; the no-echo and
  opcode-swap mutant runs incomplete at 66/247 and 181/247 with
  discrimination OUTSTANDING — **owner gate, needs Autobahn re-runs, never
