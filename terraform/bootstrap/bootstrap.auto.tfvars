...
# plumbing run failed at AssumeRoleWithWebIdentity; trusting the immutable form
# alongside the classic one is the exact case var.oidc_extra_sub_repos exists for.
