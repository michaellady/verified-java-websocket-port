...
func ValidateAutobahnDescriptor(descriptor ContainerDescriptor) error {
	...
	if descriptor.Reference != exactReference || descriptor.Platform != "linux/amd64" || descriptor.ManifestDigest != AutobahnManifestDigest || descriptor.ConfigDigest != AutobahnConfigDigest {
